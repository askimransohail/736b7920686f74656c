...
namespace _Adeel.Systems
{
    public class UnlockingSystem : MonoBehaviour
    {
        ...
        {
            progressBar.sharedMaterial.SetFloat( Arc1, 360f - testProgress * 360f);
        }
        ...
        private void UnlockProgress()
        {
            ...
            progressBar.sharedMaterial.SetFloat( Arc1, 360f - progress * 360f);
            // return Mathf.Abs(1f - (float)unlockRemainPrice / (float)unlockPrice);
        }
